...
* [Some drawings about programming](Ihttps://drawings.jvns.ca/) Very nice cartoon demonstrating useful concepts.
...
5. [furrr](https://github.com/DavisVaughan/furrr) Apply Mapping Functions in Parallel using Futures
